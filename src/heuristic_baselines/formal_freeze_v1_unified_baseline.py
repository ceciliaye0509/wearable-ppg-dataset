"""
正式冻结 v1 统一规则的 device-wise heuristic baseline。
...
from freeze_v1_primary_unified_baseline import (  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(description="正式冻结 v1 统一 baseline，不写出 strict_reference 候选扫描。")
    parser.add_argument(
        "--channel-metrics-csv",
    ...
    parser.add_argument(
        "--out-dir",
        default=str(config.HEURISTIC_RESULT_ROOT / "formal_v1_unified_baseline"),
    )
