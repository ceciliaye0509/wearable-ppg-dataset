...
Multisite runs also require pre-aligned files per participant (generated by `src/model_baselines/multisite/aligned_4device.py` — see alignment step in Quick Start):
```
